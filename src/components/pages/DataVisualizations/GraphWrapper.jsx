...
function GraphWrapper(props) {
  ...
  async function updateStateWithNewData(years, view, office, stateSettingCallback) {
    ...
    Promise.all([
      ...
      .then(([fiscalData, citizenshipData]) => { 
        const yearResults = fiscalData.data.yearResults;
        const citizenshipResults = citizenshipData.data;
      
      
      const combinedData = [{
        yearResults, citizenshipResults
      }];
